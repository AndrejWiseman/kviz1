...
import gradoviData from '../../data/gradoviData.json'
import optionsData from '../../data/optionsData.json'

import '../../assets/css/zastava-kviz.scss'
import '../../assets/css/grad-kviz.scss'
...
const QuizPage = () => {
    const [flags, setFlags] = useState(gradoviData)
    ...
    return (
      <Layout>
        <div className="kviz-container">
            ...
            {gameStarted && currentFlags.length > 0 && questionCount < 10 &&
            <div className="kviz-polje">
                <h3 className="br-pitanja">Pitanje br. {questionCount + 1}</h3>

                {/* <img src={currentFlags[questionCount].flag} alt="Flag" className="zastava" /> */}

                <h2 className="grad">{currentFlags[questionCount].flag}</h2>
            ...
            {questionCount === 10 &&
                <div className="rezultat-polje">
                    ...
                    <div className="score-polje">
                        <h3><span className="rez-span1">Rezultat je:</span> <br /> <span className="rez-span2">{score} od 10</span></h3>
